...
<a href="https://www.linkedin.com/in/mangaljeet-pandey/"><div className="text-3xl md:text-2xl text-primaryColor flex items-center">{Info.name}<IconBrandLinkedin size={30} className="ml-2"/></div></a>
